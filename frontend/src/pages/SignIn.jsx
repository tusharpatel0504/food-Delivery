    ...
    return (
        ...
        <div className='min-h-screen w-full flex items-center justify-center p-4' style=
            ...
            <div className={`bg-white rounded-xl shadow-1g w-full max-w-md p-8 border-[1px]`} style={{
                ...
                <p className='text-gray-600 mb-8'>Sign in to your account to get started with delicious
                    food deliveries
                </p>
...
' placeholder='Enter your Email' style={{
                ...
                <button className={`w-full mt-4 flex items-center justify-center gap-2 border rounded-lg px-4 py-2 transition duration-200 bg-[#ff4d2d] text-white hover:bg-[#e64323] `} onClick={handleSignin} disabled={loading}>
